...
#define CORRECTION_ROTATION_MULTIPLIER_P_GOAL 1.0
...
#define DEFEND_SIDEWAYS_MAX_SPEED 220
#define DEFEND_DISTANCE_MAX_SPEED 150
#define DEFEND_SIDEWAYS_MULTIPLIER 600
#define DEFEND_DISTANCE_MULTIPLIER 3
