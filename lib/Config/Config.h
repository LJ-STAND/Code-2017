...
#define CORRECTION_ROTATION_MULTIPLIER_P_GOAL 0.6
#define CORRECTION_ROTATION_MULTIPLIER_D_GOAL 0.1

#define CORRECTION_ROTATION_MULTIPLIER_P 1.0
#define CORRECTION_ROTATION_MULTIPLIER_D 1.0
