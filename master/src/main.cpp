...
void loop() {
    ...
    motors.move((slaveData.orbitAngle != TSOP_NO_BALL ? slaveData.orbitAngle : 0), calculateRotationCorrection(), (slaveData.orbitAngle != TSOP_NO_BALL ? slaveData.orbitSpeed : 0));
}
